...
import io.github.vdubois.validator.JobPositionValidator;
...
public class ValidatingProcessorConfiguration {
    ...
    @Bean
    public JobPositionValidator jobPositionValidator() {
        return new JobPositionValidator();
    }

    @Bean
    public ValidatingItemProcessor<User> processor(JobPositionValidator jobPositionValidator) {
        ValidatingItemProcessor<User> processor = new ValidatingItemProcessor<>();
        processor.setFilter(true);
        SpringValidator validator = new SpringValidator();
        validator.setValidator(jobPositionValidator);
    ...
    @Bean
    public Step step(StepBuilderFactory stepBuilderFactory, JpaItemWriter jpaWriter, FlatFileItemReader<User> csvReader, ValidatingItemProcessor processor) {
